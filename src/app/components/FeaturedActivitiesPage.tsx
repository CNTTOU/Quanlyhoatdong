...
interface FeaturedActivitiesPageProps {
  onLoginSuccess?: () => void;
}

export function FeaturedActivitiesPage({
  onLoginSuccess,
}: FeaturedActivitiesPageProps) {
  ...
  const handleLogin = (username: string, password: string) => {
    ...
    // Notify parent to switch to admin view
    if (onLoginSuccess) {
      onLoginSuccess();
    }
  };
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                ...
                <option value="truyen-thong">
                  Truyền thông
                </option>
                <option value="van-hoa">
                  Văn hóa - Thể thao
                </option>
              </select>
            </div>
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600 mb-6">
            Khám phá những hoạt động ý nghĩa đã để lại dấu ấn
            tích cực
          </p>
        </div>
        ...
        <div className="mt-12 bg-gradient-to-r from-blue-600 to-cyan-600 rounded-2xl p-8 text-white">
          <h3 className="text-2xl mb-6 text-center">
            Thành tích nổi bật năm học 2025-2026
          </h3>
